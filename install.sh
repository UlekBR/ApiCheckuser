...
if [[ $arch == "x86_64" || $arch == "amd64" || $arch == "x86_64h" ]]; then
    ...
    curl -o "/opt/ApiCheckuser/GoCheckuser" "https://raw.githubusercontent.com/UlekBR/ApiCheckuser/main/GoCheckuser"
...
curl -o "/opt/ApiCheckuser/menu.sh" "https://raw.githubusercontent.com/UlekBR/ApiCheckuser/main/menu.sh"
